...
const Ryans = () => {
  ...
  const startechPayments = processingPayments.filter(
    (payment) =>
      Array.isArray(payment.shopName) && payment.shopName.includes("ryans")
  );
    ...
    <div>
      <div ref={componentRef}>
        ...
        <p className="text-black text-center mb-4">
          Ryans Computers Limited Kusholi Bhaban, 238/1 Begum Rokeya Sarani,
          Taltola, Dhaka-1207, Bangladesh, <br /> +8809604442121, +8801755662121
          info@ryans.com
        </p>{" "}
