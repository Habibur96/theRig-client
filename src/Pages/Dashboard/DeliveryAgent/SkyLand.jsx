...
const UltraTech = () => {
  ...
  const startechPayments = processingPayments.filter(
    (payment) =>
      Array.isArray(payment.shopName) && payment.shopName.includes("skyland")
  );
    ...
    <div>
      <div ref={componentRef}>
        ...
        <p className="text-black text-center mb-4">
          Skyland Computer BD <br /> Phone: 01748-094107 <br /> Email: skyland.sc@gmail.com <br />
          Location: Shop: 1111, Level: 11, Multiplan, Dhaka
        </p>{" "}
