const MemoryDetails = () => {
  return (
    ...
    <div className="mt-4 bg-[#82d9eb] h-14 ">
      <h1 className="pt-2 pl-3 font-semibold text-xl"
      >Basic Information</h1>
    </div>
    <table className="border-1 shadow-lg w-full">
<thead className="bg-[#00b16a]">
  <tr>
    {/* <th className="border p-4 w-1/4">Basic Information</th>
    <th className="p-4 w-3/4"></th> */}
  </tr>
</thead>
<tbody>
  <tr>
    <td className="border p-4 w-1/4">Brand</td>
    <td className="p-4 w-3/4">dynamic value</td> {/* Adjusted width of the second column */}
  </tr>
  <tr>
