...
const Navber2 = () => {
  ...
  >
    <AccordionItem eventKey="1">
      <AccordionButton className="accordion-header">Products</AccordionButton>
        ...
        <div className="browseProducts__wrapper ml-3 mr-5 text-center">
          <div>
            <ul className="browseProducts">
              <li>
                {" "}
                <Link to="/cpu" onClick={handleLinkClick}>
                  <img
              ...
              <li>
                {" "}
                <Link to='/motherboard'onClick={handleLinkClick}>
                  <img
          ...
          <div>
            <ul className="Peripherals text-center;">
              ...
              <li>
                <Link onClick={handleLinkClick}>
                  <img style={{ height: 190 }} src={monitor} alt="" /> Monitor
                </Link>
              </li>
              <li>
                <Link onClick={handleLinkClick}>
                  <img style={{ height: 180 }} src={casingCooler} alt="" />{" "}
                  Casing Cooler
                </Link>
              </li>
              <li>
